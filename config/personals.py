...
# Your legal name
first_name = "Tom"                 # Your first name in quotes Eg: "First", "Sai"
middle_name = "Bruno"            # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Arc"                # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "6255898930"        # Enter your 10 digit number in quotes Eg: "9876543210"

# What is your current city?
current_city = "Chihuahua, Chihuahua, Mexico"                  # Los Angeles, San Francisco, etc.
'''
